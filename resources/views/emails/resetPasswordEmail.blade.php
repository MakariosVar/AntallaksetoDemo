...
<head>
    ...
    <body>
        ...
        <p><a href="{{ env('FRONT_END_URL').'/passwordSet?token='.$user->reset_password_token }}">Επαναφωρά Κωδικού</a></p>
        <p>Ή εδώ: <a href="{{ env('FRONT_END_URL').'/passwordSet?token='.$user->reset_password_token }}">{{ env('FRONT_END_URL').'/passwordSet?token='.$user->reset_password_token }}</a></p>
