          ...
          <div class="u-layout">
            <div class="d-flex justify-content-center">
              <div>
                <div class="u-container-layout u-container-layout-1">
                  <div class="u-expanded-width u-form u-form-1 ">
                    <form action="/p/search" class="row" method="GET"  >
                      
                      
                      <div class="u-form-group u-form-name u-label-top">
                        <label for="title" class="u-label">Αναζήτηση</label>
                        <input type="text" class="u-border-1 u-border-grey-30  u-input-rectangle u-white form-control" placeholder="Ψάχνω για.." name="title">
                      </div>


                      <div class="u-form-group u-label-top">
                        <label for="category" class="u-label">Κατηγορία</label>
                        <select id="category" name="category"  class="form-select form-control form-control"  aria-label="category">
              ...
              <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2 p-1 u-border-1">
